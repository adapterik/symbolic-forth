...
//     `);
    ...
    forth.interpreter.run(`
        " Get canvas context" PRINTLN
        " canvas" canvas::context LOCAL context

        " Create green filled rectangle" PRINTLN
        " green" LOCAL@ context canvas::fill_style
        10 10 50 50 LOCAL@ context canvas::fill_rect


        " Create a red filled rectangle" PRINTLN
        " red" L@ context canvas::fill_style
        60 60 40 40 LOCAL@ context canvas::fill_rect

        " Create some blue text" PRINTLN
        " orange" LOCAL@ context canvas::fill_style
        " bold 100px courier" LOCAL@ context canvas::font

        " Hello!" 100 150 LOCAL@ context canvas::fill_text
