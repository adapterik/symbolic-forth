...
const SYMBOL_TEST_2 = `
SYM symbol1 SYM symbol1 EQ test::assert_true

test::assert_stack_empty
`;

const SYMBOL_TEST_3 = `
10 SYM symbol1 SVALUE!

SYM symbol1 SVALUE@ 10 = test::assert_true
...
export default function AddSymbolTests(testing) {
    ...
    testing.add_test('symbol', 'type', 'Creating a symbol with SYM  is of the correct type', SYMBOL_TEST_1);
