...
function var_word({interpreter, forth}) {
...
function store_word({interpreter, forth}) {
    // const variable_ref = interpreter.next_input_token();
    // if (!variable_ref) {
...
const CoreVocabulary = (forth, options = {}) => {
    ...
    forth.add_word('', '!', store_word);
    forth.add_word('', '@', fetch_word);
    forth.add_word('', '!INC', inc_var_word);
    forth.add_word('', 'INC!', inc_var_word);
    forth.add_word('', 'DEC!', dec_var_word);
